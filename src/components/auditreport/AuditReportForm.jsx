...
import { InputField, RadioGroup, SelectField } from '../ui/FormFields';
...
import Step2Permissions from './Step2Permissions';
import Step3ScheduleIX from './Step3ScheduleIX';
import Step4IncomeExpenditure from './Step4IncomeExpenditure';
import Step5BalanceSheet from './Step5BalanceSheet';
import Step6ReceiptPayment from './Step6ReceiptPayment';
import Step7Schedule9D from './Step7Schedule9D';
import Step8DelayExemption from './Step8DelayExemption';
              ...
              <AnimatePresence mode="wait">
                ...
                {currentStep === 1 && (
                  <motion.div key="step1" initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }} exit={{ opacity: 0, x: 20 }}>
                    <Step1BasicDetails formData={formData} onChange={handleChange} reportType={reportType} setReportType={setReportType} />
                  </motion.div>
                )}
