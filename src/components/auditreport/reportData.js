...
//     isHeader: true,
//     subFields: [
//       { key: "exp_rates_taxes", label: "Rates, Taxes, Cesses" },
...
//   { key: "exp_remuneration_head", label: "To Remuneration To Head Of Math" },
//   { key: "exp_legal", label: "To Legal Expenses" },
//   { key: "exp_audit", label: "To Audit Fees" },
//   { key: "exp_contribution_fees", label: "To Contribution And Fees" },
//   {
...
//   { key: "exp_depreciations", label: "To Depreciations" },
//   { key: "exp_transfer_reserve", label: "To Amounts Transferred To Reserve or Specific Funds" },
//   {
...
//     isHeader: true,
//     subFields: [
//       { key: "inc_rent_accrued", label: "Accrued" },
//       { key: "inc_rent_realised", label: "Realised" }
//     ]
//   },
//   {
//     key: "inc_interest",
...
//     isHeader: true,
//     subFields: [
//       { key: "inc_interest_accrued", label: "Accrued" },
//       { key: "inc_interest_realised", label: "Realised" },
//       { key: "inc_interest_securities", label: "On Securities" },
//       { key: "inc_interest_loan", label: "On Loan" },
//       { key: "inc_interest_bank", label: "On Bank Account" }
//     ]
//   },
//   { key: "inc_dividend", label: "By Dividend" },
//   { key: "inc_donations", label: "By Donations In Cash Or Kind" },
//   { key: "inc_grants", label: "By Grants" },
//   { key: "inc_other_sources", label: "By Income From Other Sources" },
//   { key: "inc_transfer_reserve", label: "By Transfer From Reserve" }
// ];
// Step 4: Income & Expenditure — left side (Expenditure)
// Step 4: Income & Expenditure — Left Side (Expenditure)
export const expenditureItems = [
